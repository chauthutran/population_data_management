import { initChartX, initChartY, initOrgUnitLevel, orgUnitRoot } from "@/constants/initData";
...
const dataElements = [
    {
        ...
        "description": "The population of individuals aged 60 and above within the organizational unit."
    },
    {
        "_id": "60c72b2f9c29f80015e5f731",
        "name": "Urban Population",
        "shortName": "urban_population",
        "description": "The population residing in urban areas within the organizational unit."
    },
    {
        "_id": "60c72b2f9c29f80015e5f732",
        "name": "Rural Population",
        "shortName": "rural_population",
        "description": "The population residing in rural areas within the organizational unit."
    }
]
...
export default function DashboardChart2 () {
    ...
    const fetchChartData = async (): Promise<IChartData> => {
        ...
        const result = transformData(data, initChartX, initChartY, orgUnits, dataElements, periods);
        return result;
    }
    ...
    return (
        <>
            <div className="p-6 bg-white shadow rounded-lg">
                <h3 className="text-lg font-bold mb-4">{dataElements.map((item) => item.name).join(" & ")}</h3>
