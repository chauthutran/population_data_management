import { initChartX, initChartY, initDataElements, initOrgUnitLevel, orgUnitRoot } from "@/constants/initData";
...
export default function DashboardChart1 () {
    ...
    const fetchChartData = async (): Promise<IChartData> => {
        const periodCodes = ["2018", "2019","2020","2021","2022","2023", "2024"];
        ...
        return transformData(data, initChartX, initChartY, orgUnits, initDataElements, periods);
    }
    ...
    return (
        <>
            <div className="p-6 bg-white shadow rounded-lg">
                <h3 className="text-lg font-bold mb-4">{initDataElements.map((item) => item.name).join(" & ")}</h3>
