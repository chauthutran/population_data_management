...
export default function CurrentApprovalStatus() {
    ...
    const getIcon = () => {
        if (approvalStatus === DATA_UNAPPROVED)
            return <FiClock className="text-yellow-500 text-2xl" />;

        if (approvalStatus === DATA_APPROVED)
            return <FaCheckCircle className="text-blue-400 text-2xl" />;
            ...
            <div className="flex items-center">
                ...
                <span className="ml-2 font-semibold">
                    {approvalStatus === DATA_UNAPPROVED && (
                        <p className="text-yellow-500">Ready to approve</p>
                    )}
