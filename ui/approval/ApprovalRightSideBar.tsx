...
export default function ApprovalRightSideBar() {
    ...
    return (
        <div className="flex flex-col h-[70vh] overflow-y-auto flex-1 bg-gray-100 shadow-md rounded-lg p-5 border border-gray-200">
            ...
            {/* Approval Checklist */}
            <section className="mb-6 border-b pb-4">
                <h3 className="text-lg font-semibold text-gray-800 mb-3">✅ Approval Checklist</h3>
            ...
            <section>
                ...
                <p className="text-gray-700 text-sm">
                    Once you approve this data, it will be processed and finalized for reporting.
