                    ...
                    <header>
                        {(!selectedDataSet || !selectedPeriod || !selectedOrgUnit) 
                            ...
                            : <>
                                ...
                                <p className="text-gray-600">Please review the submitted data carefully. Ensure all the required fields are correct before approving. If there are any discrepancies, please flag them for review.</p>
                            </>
                        }
                    </header>
