...
export default function CustomSelect<T>({
    ...
    const displayedTitle = selectedItem
        ? (selectedItem as any)[displayProp]
        : title;
    ...
    return (
        ...
        >
            ...
            />
            {showed && (
                <div className="absolute w-full rounded-md z-50 top-10 left-0 right-0 bg-white shadow-lg overflow-y-auto">
