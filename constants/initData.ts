    ...
    dataElements: [
        {
            ...
            description:
                'The total number of people residing in the organizational unit. It represents the complete population count for a given time period.',
        },
        {
            ...
            description:
                'The rate at which the population of the organizational unit is growing, expressed as a percentage over a specific time period (monthly or yearly).',
        },
        {
            ...
            description:
                'The number of people per unit of area (e.g., per square kilometer) within the organizational unit.',
        },
        {
            ...
            description:
                'The total number of male individuals residing in the organizational unit.',
        },
        {
            ...
            description:
                'The total number of female individuals residing in the organizational unit.',
        },
    ],
    periodType: {
