...
export const useChart = () => {
    ...
    const selectedPeriods = useSelector(
        (state: RootState) => state.chart.periods,
        shallowEqual,
    );
    const selectedDataElements = useSelector(
        (state: RootState) => state.chart.dataElements,
        shallowEqual,
    );
    const selectedOrgUnit = useSelector(
        (state: RootState) => state.chart.orgUnit,
        shallowEqual,
    );
    const selectedOrgUnitLevel = useSelector(
        (state: RootState) => state.chart.orgUnitLevel,
        shallowEqual,
    );
    const selectedChartX = useSelector(
        (state: RootState) => state.chart.chartX,
        shallowEqual,
    );
    const selectedChartY = useSelector(
        (state: RootState) => state.chart.chartY,
        shallowEqual,
    );
    const selectedChartType = useSelector(
        (state: RootState) => state.chart.chartType,
        shallowEqual,
    );
    ...
    const selectDataElements = useCallback(
    ...
    const selectOrgUnitLevel = useCallback(
    ...
    const selectChartX = useCallback(
        (chartX: IChartAxist[]) => {
    ...
    const selectChartY = useCallback(
        (chartY: IChartAxist[]) => {
